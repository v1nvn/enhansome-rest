# Awesome REST [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,721 | 🐛 71 | 📅 2026-01-28 with stars
...
* [HTTP API design guide extracted from work on the Heroku Platform API](https://github.com/interagent/http-api-design) ⭐ 13,696 | 🐛 30 | 📅 2024-01-16
...
* [Refit](https://github.com/reactiveui/refit) ⭐ 9,394 | 🐛 202 | 🌐 C# | 📅 2026-02-15 - The automatic type-safe REST library for Xamarin and .NET
* [RestEase](https://github.com/canton7/RestEase) ⭐ 1,108 | 🐛 15 | 🌐 C# | 📅 2023-12-10 - Easy-to-use typesafe REST API client library, which is simple and customisable. Heavily inspired by Refit
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,818 | 🐛 5,580 | 🌐 Java | 📅 2026-02-15 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 26,517 | 🐛 381 | 🌐 Haskell | 📅 2026-02-15 - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [Fusio](https://github.com/apioo/fusio) ⭐ 2,070 | 🐛 172 | 🌐 PHP | 📅 2026-02-07 - Open source API management platform.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,551 | 🐛 194 | 🌐 PHP | 📅 2026-02-13 - Build a REST API which follow Hydra/JSON-LD specification.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,025 | 🐛 109 | 🌐 PowerShell | 📅 2026-02-04 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 95,124 | 🐛 140 | 🌐 Python | 📅 2026-02-14 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,801 | 🐛 163 | 🌐 Python | 📅 2026-01-25 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,599 | 🐛 34 | 🌐 Java | 📅 2026-02-15 - A framework for developing ops-friendly, high-performance, RESTful web services.
* [Vertx-Web](https://github.com/vert-x3/vertx-web) ⭐ 1,144 | 🐛 146 | 🌐 Java | 📅 2026-02-13 - Vert.x-Web is a set of building blocks for building web applications with Vert.x, a toolkit for building reactive applications on the JVM.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 37,937 | 🐛 808 | 🌐 TypeScript | 📅 2026-02-13 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 37,558 | 🐛 241 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 33,532 | 🐛 452 | 🌐 C | 📅 2026-02-01 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
* [HTTP Prompt](https://github.com/eliangcs/http-prompt) ⭐ 9,103 | 🐛 53 | 🌐 Python | 📅 2024-05-21 - HTTP Prompt is an interactive command-line HTTP client featuring autocomplete and syntax highlighting, built on HTTPie and prompt\_toolkit.
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,045 | 🐛 41 | 🌐 Python | 📅 2026-02-15 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,630 | 🐛 707 | 🌐 JavaScript | 📅 2026-02-14 - Serve a REST API from fixture files using quick prototyping.
...
* [Public APIS](https://github.com/public-apis/public-apis) ⭐ 398,574 | 🐛 850 | 🌐 Python | 📅 2025-11-04 - Explore The Largest API Directory In The Galaxy.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,494 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 42,774 | 🐛 130 | 🌐 Lua | 📅 2026-01-19 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,633 | 🐛 388 | 🌐 Go | 📅 2026-02-13 - Lightweight API gateway with analytics logging, written in Go.
* [KrakenD](https://github.com/devopsfaith/krakend) ⭐ 6,734 | 🐛 7 | 🌐 Go | 📅 2026-02-10 - Ultra performant API Gateway with middleware. Written in Go.
...
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,145 | 🐛 246 | 🌐 Ruby | 📅 2026-02-14 - API management platform for exposing web services, with web interface and analytics, written in Lua.
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 966 | 🐛 656 | 🌐 Java | 📅 2026-02-13 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 6,619 | 🐛 40 | 🌐 TypeScript | 📅 2026-02-13 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,532 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-14 - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,704 | 🐛 3,436 | 🌐 Mustache | 📅 2026-02-05 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
...
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 747 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-13 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
