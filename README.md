# Awesome REST [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,983 | 🐛 70 | 📅 2026-01-28 with stars
...
* [API-Security-Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,171 | 🐛 2 | 📅 2026-02-10 - Best practices about REST API security
* [HTTP API design guide extracted from work on the Heroku Platform API](https://github.com/interagent/http-api-design) ⭐ 13,698 | 🐛 30 | 📅 2024-01-16
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/vNext/Guidelines.md#readme) ⭐ 23,234 | 🐛 168 | 📅 2025-08-11 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
* [Restful API Guidelines by Zalando](https://github.com/zalando/restful-api-guidelines) ⭐ 3,146 | 🐛 18 | 🌐 CSS | 📅 2026-02-20 - Developing Restful APIs: A Comprehensive Set of Guidelines.
...
* [JSend](https://github.com/omniti-labs/jsend) ⭐ 1,709 | 🐛 9 | 📅 2022-01-21 - Simple specification that lays down some rules for how JSON responses from web servers should be formatted.
...
* [restangular](https://github.com/mgonto/restangular) ⭐ 7,814 | 🐛 254 | 🌐 JavaScript | 📅 2020-10-05 - AngularJS service to handle REST API properly and easily.
...
* [httparty](https://github.com/jnunemaker/httparty) ⭐ 5,894 | 🐛 44 | 🌐 Ruby | 📅 2026-01-14 - Makes HTTP fun again!
* [RESTClient](https://github.com/rest-client/rest-client) ⭐ 5,229 | 🐛 139 | 🌐 Ruby | 📅 2024-05-19 - Simple HTTP and REST client for Ruby, inspired by microframework syntax for specifying actions.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,550 | 🐛 6 | 🌐 Go | 📅 2026-02-15 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
* [gopencils](https://github.com/bndr/gopencils) ⭐ 453 | 🐛 7 | 🌐 Go | 📅 2019-02-18 - Small and simple package to easily consume REST APIs.

### .NET Clients

* [RestSharp](https://github.com/restsharp/RestSharp) ⭐ 9,830 | 🐛 35 | 🌐 C# | 📅 2026-02-06 - Simple REST and HTTP API client for .NET
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,847 | 🐛 5,599 | 🌐 Java | 📅 2026-02-20 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 26,546 | 🐛 381 | 🌐 Haskell | 📅 2026-02-20 - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,712 | 🐛 130 | 🌐 JavaScript | 📅 2024-09-19 - Framework specifically meant for REST API.
...
* [Restler](https://github.com/Luracast/Restler) ⭐ 1,369 | 🐛 35 | 🌐 PHP | 📅 2025-12-02 - Lightweight framework to expose PHP methods as RESTful web API.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,113 | 🐛 720 | 🌐 TypeScript | 📅 2026-02-04 - Specialize Symfony edition for the creation of hypermedia REST APIs.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,551 | 🐛 198 | 🌐 PHP | 📅 2026-02-20 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,334 | 🐛 91 | 🌐 PHP | 📅 2026-02-20 - Generate documentation for your REST API from annotations.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,026 | 🐛 110 | 🌐 PowerShell | 📅 2026-02-20 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 95,391 | 🐛 148 | 🌐 Python | 📅 2026-02-20 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
...
* [go-restful](https://github.com/emicklei/go-restful) ⭐ 5,111 | 🐛 3 | 🌐 Go | 📅 2025-12-15 - A declarative highly readable framework for building restful API's.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,600 | 🐛 36 | 🌐 Java | 📅 2026-02-20 - A framework for developing ops-friendly, high-performance, RESTful web services.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 37,948 | 🐛 811 | 🌐 TypeScript | 📅 2026-02-17 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 37,578 | 🐛 244 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 33,691 | 🐛 456 | 🌐 C | 📅 2026-02-01 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,111 | 🐛 586 | 🌐 Java | 📅 2026-02-04 - Java DSL for easy testing of REST services.
...
* [Http-console](https://github.com/cloudhead/http-console) ⭐ 1,478 | 🐛 14 | 🌐 JavaScript | 📅 2021-06-07 - Command line interface for HTTP that let you *speak HTTP like a local*
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,641 | 🐛 706 | 🌐 JavaScript | 📅 2026-02-19 - Serve a REST API from fixture files using quick prototyping.
...
* [Public APIS](https://github.com/public-apis/public-apis) ⭐ 399,317 | 🐛 870 | 🌐 Python | 📅 2026-02-19 - Explore The Largest API Directory In The Galaxy.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,506 | 🐛 430 | 🌐 TypeScript | 📅 2026-02-07 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 42,802 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,637 | 🐛 395 | 🌐 Go | 📅 2026-02-20 - Lightweight API gateway with analytics logging, written in Go.
* [KrakenD](https://github.com/devopsfaith/krakend) ⭐ 6,735 | 🐛 7 | 🌐 Go | 📅 2026-02-10 - Ultra performant API Gateway with middleware. Written in Go.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 6,668 | 🐛 39 | 🌐 TypeScript | 📅 2026-02-21 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,540 | 🐛 65 | 🌐 TypeScript | 📅 2026-02-20 - Add a ReactJS admin GUI to any RESTful API.
...
* [ng-admin](https://github.com/marmelab/ng-admin) ⭐ 3,920 | 🐛 111 | 🌐 JavaScript | 📅 2020-06-01 - Add an AngularJS admin GUI to any RESTful API.
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 755 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-20 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
