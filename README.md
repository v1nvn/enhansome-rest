# Awesome REST [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,155 | 🐛 70 | 📅 2026-01-28 with stars
...
* [API-Security-Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,170 | 🐛 2 | 📅 2026-02-10 - Best practices about REST API security
...
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines/blob/vNext/Guidelines.md#readme) ⭐ 23,232 | 🐛 168 | 📅 2025-08-11 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
...
* [JSend](https://github.com/omniti-labs/jsend) ⭐ 1,706 | 🐛 9 | 📅 2022-01-21 - Simple specification that lays down some rules for how JSON responses from web servers should be formatted.
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,542 | 🐛 6 | 🌐 Go | 📅 2026-02-15 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [Refit](https://github.com/reactiveui/refit) ⭐ 9,398 | 🐛 203 | 🌐 C# | 📅 2026-02-18 - The automatic type-safe REST library for Xamarin and .NET
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,829 | 🐛 5,594 | 🌐 Java | 📅 2026-02-18 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 26,527 | 🐛 381 | 🌐 Haskell | 📅 2026-02-18 - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,714 | 🐛 130 | 🌐 JavaScript | 📅 2024-09-19 - Framework specifically meant for REST API.
* [Nestjsx/crud](https://github.com/nestjsx/crud) ⭐ 4,322 | 🐛 292 | 🌐 TypeScript | 📅 2024-07-16 - Generate CRUD controllers and services for RESTful API with NestJS and TypeORM.
...
* [Restler](https://github.com/Luracast/Restler) ⭐ 1,369 | 🐛 32 | 🌐 PHP | 📅 2025-12-02 - Lightweight framework to expose PHP methods as RESTful web API.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,109 | 🐛 719 | 🌐 TypeScript | 📅 2026-02-04 - Specialize Symfony edition for the creation of hypermedia REST APIs.
* [FOSRestBundle](https://github.com/FriendsOfSymfony/FOSRestBundle) ⭐ 2,802 | 🐛 157 | 🌐 PHP | 📅 2026-02-10 - Bundle handling view, routing, error handling, etc. for your REST API.
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,551 | 🐛 200 | 🌐 PHP | 📅 2026-02-17 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,334 | 🐛 90 | 🌐 PHP | 📅 2026-02-13 - Generate documentation for your REST API from annotations.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 95,194 | 🐛 140 | 🌐 Python | 📅 2026-02-17 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,802 | 🐛 163 | 🌐 Python | 📅 2026-02-16 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 37,943 | 🐛 807 | 🌐 TypeScript | 📅 2026-02-17 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 37,567 | 🐛 244 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 33,538 | 🐛 454 | 🌐 C | 📅 2026-02-01 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,046 | 🐛 41 | 🌐 Python | 📅 2026-02-17 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,635 | 🐛 708 | 🌐 JavaScript | 📅 2026-02-18 - Serve a REST API from fixture files using quick prototyping.
...
* [Public APIS](https://github.com/public-apis/public-apis) ⭐ 398,846 | 🐛 855 | 🌐 Python | 📅 2025-11-04 - Explore The Largest API Directory In The Galaxy.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,495 | 🐛 429 | 🌐 TypeScript | 📅 2026-02-07 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 42,785 | 🐛 130 | 🌐 Lua | 📅 2026-01-19 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,634 | 🐛 393 | 🌐 Go | 📅 2026-02-17 - Lightweight API gateway with analytics logging, written in Go.
...
* [Express Gateway](https://github.com/ExpressGateway/express-gateway) ⭐ 3,036 | 🐛 78 | 🌐 JavaScript | 📅 2024-05-14 - Microservices API Gateway built on top of ExpressJS (Node.js).
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,145 | 🐛 243 | 🌐 Ruby | 📅 2026-02-18 - API management platform for exposing web services, with web interface and analytics, written in Lua.
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 966 | 🐛 658 | 🌐 Java | 📅 2026-02-18 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 6,635 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-17 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,536 | 🐛 68 | 🌐 TypeScript | 📅 2026-02-17 - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,707 | 🐛 3,437 | 🌐 Mustache | 📅 2026-02-17 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
...
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 748 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-17 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
