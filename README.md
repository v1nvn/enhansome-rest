# Awesome REST [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,352 | 🐛 69 | 📅 2026-01-28 with stars
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,524 | 🐛 9 | 🌐 Go | 📅 2026-02-01 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
* [gopencils](https://github.com/bndr/gopencils) ⭐ 453 | 🐛 7 | 🌐 Go | 📅 2019-02-18 - Small and simple package to easily consume REST APIs.

### .NET Clients

* [RestSharp](https://github.com/restsharp/RestSharp) ⭐ 9,824 | 🐛 36 | 🌐 C# | 📅 2026-02-06 - Simple REST and HTTP API client for .NET
* [Refit](https://github.com/reactiveui/refit) ⭐ 9,392 | 🐛 201 | 🌐 C# | 📅 2026-02-09 - The automatic type-safe REST library for Xamarin and .NET
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,781 | 🐛 5,586 | 🌐 Java | 📅 2026-02-09 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 26,486 | 🐛 372 | 🌐 Haskell | 📅 2026-02-08 - Serve a fully RESTful API directly from an existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,517 | 🐛 146 | 🌐 Go | 📅 2026-02-09 - A fully RESTful API from any existing PostgreSQL database written in Go.
...
* [FOSRestBundle](https://github.com/FriendsOfSymfony/FOSRestBundle) ⭐ 2,804 | 🐛 157 | 🌐 PHP | 📅 2026-02-10 - Bundle handling view, routing, error handling, etc. for your REST API.
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,551 | 🐛 200 | 🌐 PHP | 📅 2026-02-09 - Build a REST API which follow Hydra/JSON-LD specification.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 94,957 | 🐛 165 | 🌐 Python | 📅 2026-02-09 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,799 | 🐛 163 | 🌐 Python | 📅 2026-01-25 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,594 | 🐛 34 | 🌐 Java | 📅 2026-02-10 - A framework for developing ops-friendly, high-performance, RESTful web services.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 37,923 | 🐛 816 | 🌐 TypeScript | 📅 2026-02-09 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 37,520 | 🐛 240 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 33,507 | 🐛 451 | 🌐 C | 📅 2026-02-01 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,033 | 🐛 40 | 🌐 Python | 📅 2026-02-10 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,630 | 🐛 707 | 🌐 JavaScript | 📅 2026-02-07 - Serve a REST API from fixture files using quick prototyping.
...
* [Public APIS](https://github.com/public-apis/public-apis) ⭐ 397,317 | 🐛 832 | 🌐 Python | 📅 2025-11-04 - Explore The Largest API Directory In The Galaxy.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,482 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-07 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 42,725 | 🐛 131 | 🌐 Lua | 📅 2026-01-19 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,626 | 🐛 392 | 🌐 Go | 📅 2026-02-09 - Lightweight API gateway with analytics logging, written in Go.
...
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,145 | 🐛 243 | 🌐 Ruby | 📅 2026-02-09 - API management platform for exposing web services, with web interface and analytics, written in Lua.
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 965 | 🐛 654 | 🌐 Java | 📅 2026-02-03 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 6,566 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-09 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,521 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-09 - Add a ReactJS admin GUI to any RESTful API.
...
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 736 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-09 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
